Portlogger evolved as a sketch in the Processing language to receive data from the serial monitor and print it to a screen window, as well as write it to a log file in the same directory as the sketch.
